...
Usage:
  python3 -m receipts.verify_receipt --base-url https://runtime.example \
      --public-key <64 hex> --request-id <id> [--prompt-file req.json] [--response-file answer.txt]
  python3 -m receipts.verify_receipt --manifest-file m.json --receipt-file r.json --public-key <hex>
"""
...
from receipts.schema import (Signed, check_manifest, check_receipt, check_route_manifest, check_route_receipt, is_route_document,
                             manifest_identity)
