...
Usage:
  python3 -m watch.run --targets watch/targets.json --out runs [--samples 5] [--needle-sizes 8000,32000]
...
from watch.battery import BATTERY_VERSION, NEEDLE_SIZES_DEFAULT, Probe, battery_id, build_battery, evaluate_canary
