...
watch recorded it hour by hour: the fingerprint by sampling, with the published weights on one side.
    ...
    python -m watch.reference.analyze_sampled --result runs-reference/<id>-sampled.json --runs <dir with fingerprint runs> \
...
from watch.board import list_runs, load_run
