...
from registry.publish import ObjectStore, S3Store
...
def post_signed(url: str, data: bytes, seed_hex: str, *, opener=None, timeout: float = 30.0) -> dict[str, Any]:
    ...
    from watch.client import USER_AGENT
    from watch.sign import sign
...
def reveal_documents(fingerprints_dir: Path, current_week: str) -> dict[str, bytes]:
    ...
    """
    from watch.fingerprint import commitment, reveal_document
    ...
    if args.registry:
        ...
        try:
            ...
            if args.reveal and args.reveal.exists():
                ...
                from watch.fingerprint import iso_week
