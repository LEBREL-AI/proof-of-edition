...
from proof_of_edition.watch.compare import (DEFAULT_ALPHA, DEFAULT_KERNEL_TOKENS, DEFAULT_MIN_EXACT_RATE, DEFAULT_MIN_PREFIX_AGREEMENT,
                           DEFAULT_PERMUTATIONS, deterministic_agreement, two_sample_test)
from proof_of_edition.watch.fingerprint import (CLOUD_MIN_PASSES, FINGERPRINT_VERSION, HISTORY_SECONDS, HOURS, INFORMATIVE_MAX_TOP, MARGIN_OUTSIDE_NATS,
