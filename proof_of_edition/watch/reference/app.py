"""The reference: a lab's published weights, run by us, measured with the fingerprint prompts.
    ...
    modal run proof_of_edition/watch/reference/app.py --action download          # weights into the volume (CPU, once)
    modal run proof_of_edition/watch/reference/app.py --action measure --prompts prompts.json --out runs-reference/<id>.json
